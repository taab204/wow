                ...
                <div class="content-header row">
                    ...
                    <div class="row breadcrumbs-top">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ url('admin/asesorcampo/viewasesorcampo/' . auth()->user()->id) }}">Vista</a> </li>
                                                    ...
                                                    <form>
                                                        ...
                                                        <div class="card-body">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control" value="{{ $cliente_detail->name }}" disabled>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-2">
                                                                    <div class="form-group">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-5">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control" value="{{ $cliente_detail->direc }}" disabled>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        <label>Referencia de la Dirección :</label>
                                                                        <input type="text" class="form-control" value="{{ $cliente_detail->dref }}" disabled>
                                                                    </div>
                                                                ...
                                                                <div class="col-md-3">
                                                                    <div class="form-group">
                                                                        <label>Email :</label>
                                                                        <input type="text" class="form-control" value="{{ $cliente_detail->email }}" disabled>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control" value="{{ $cliente_detail->distri }}" disabled>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <textarea name="obs" class="form-control" placeholder="Sin registro" cols="30" rows="20" disabled>{{ $cliente_detail->obs }}</textarea>
                                                            </div>
                                                        </div>
                                                    </form>
                                                </div>
