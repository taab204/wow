                ...
                <div class="card">
                        ...
                        <div class="col-12">
                            <div class="card-body">
                                ...
                                <table id="asesorCampo" class="table table-bordered" style="width:100%">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>Cod. Cliente</th>
                                    ...
                                    <tbody>
                                        @foreach ($clientesfiltro as $row)
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if ($row->id_estado == 1)
                                                            <a class="badge badge-light-success">{{ $row->RELESTADO->name }}</a>
                                                        @elseif ($row->id_estado == 4)
                                                            <a class="badge badge-light-primary">{{ $row->RELESTADO->name }}</a>
                                                        @elseif ($row->id_estado == 7)
                                                            <a class="badge badge-light-secondary">{{ $row->RELESTADO->name }}</a>
                                                        @elseif ($row->id_estado == 8)
                                                            <a class="badge badge-light-warning">{{ $row->RELESTADO->name }}</a>
                                                        @elseif ($row->id_estado == 10)
                                                            <a class="badge badge-light-success">{{ $row->RELESTADO->name }}</a>
                                                        @elseif ($row->id_estado == 11)
                                                            <a class="badge badge-light-dark">{{ $row->RELESTADO->name }}</a>
                                                        @elseif ($row->id_estado == 12)
                                                            <a class="badge badge-light-success">{{ $row->RELESTADO->name }}</a>
                                                        @elseif ($row->id_estado == 14)
                                                            <a class="badge badge-light-success">{{ $row->RELESTADO->name }}</a>
                                                        @elseif ($row->id_estado == 15)
                                                            <a class="badge badge-light-info">{{ $row->RELESTADO->name }}</a>
                                                    ...
                                                    <td class="project-actions text-right">
                                                        @if ($row->id_estado == 1)
                                                            <a class="btn btn-datatable btn-icon btn-transparent-dark me-2" href="{{ route('admin_detailasesorcampo', $row->id) }}">
                                                                <i data-feather="eye">
                                                                </i>
                                                            </a>
                                                        @elseif ($row->id_estado == 10)
                                                        ...
                                                        @elseif ($row->id_estado == 4)
                                                            <a class="btn btn-datatable btn-icon btn-transparent-dark me-2"
                                                                href="{{ route('admin_editasesorcampo', $row->id) }}">
                                                                <i data-feather="edit">
                                                                </i>
                                                            </a>
                                                        @elseif ($row->id_estado == 8)
