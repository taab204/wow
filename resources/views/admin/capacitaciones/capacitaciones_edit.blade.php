                ...
                <section>
                    <div class="col-xl-12">
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <form action="{{ route('admin_updatecapacitacion', $editar_capacitacion->id) }}"
                                ...
                                <div class="form-group">
                                    <label class="form-label">Foto DNI Frontal *</label>
                                        <div class="col-sm-6">
                                            <img src="{{ asset('uploads/capacitaciones/'.$editar_capacitacion->url)}}" alt="" class="img-fluid mb-3">
                                        </div>
                                        <label for="exampleInputFile"></label>
                                        <div class="input-group">
                                          <div class="custom-file">
                                            <input type="file" name="url" class="custom-file-input" id="exampleInputFile" value="{{ $editar_capacitacion->url }}">
                                            <label class="custom-file-label" for="exampleInputFile">{{ $editar_capacitacion->url }}</label>
                                          </div>
                                        </div>
                                </div>
                            </div> --}}
                                                    ...
                                                    <div class="input-group">
                                                        <div class="custom-file">
                                                            ...
                                                            <label class="custom-file-label"
                                                                for="exampleInputFile">{{ $editar_capacitacion->url }}</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="title"
                                                        placeholder="Ingresar" value="{{ $editar_capacitacion->title }}">
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <label>Detalle :</label>
                                            <textarea name="detail" class="form-control" placeholder="Ingresar" cols="30" rows="3">{{ $editar_capacitacion->detail }}</textarea>
                                        </div>
                                        <!-- /.card-body -->
