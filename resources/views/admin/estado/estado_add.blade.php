                        ...
                        <section id="multiple-column-form">
                            <div class="col-xl-12">
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        <form action="{{ route('admin_estado_store') }}" method="post" enctype="multipart/form-data">
                                            @csrf
            
                                            <div class="mb-3">
                                                <label class="form-label">Nombre</label>
                                                <input class="form-control text-uppercase" type="text" placeholder="Ingresar" name="name" value="{{ old('name') }}" />
                                            </div>
            
                                            <div class="mb-3">
                                                <label class="form-label">Descripción</label>
            
                                                <textarea class="form-control text-uppercase" type="text" placeholder="Ingresar" name="detail" cols="30" rows="3" >{{ old('detail') }}</textarea>
