                                        ...
                                        <form action="{{ route('admin_planes_store') }}" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="row gx-3 mb-3">
                                                <div class="col-md-4">
                                                    ...
                                                    <input class="form-control text-uppercase" type="text" placeholder="Ingresar" name="plan" value="{{ old('plan') }}" required/>
                                                </div>
                                                <div class="col-md-2">
                                                    <label class="form-label">Precio Venta</label>
                                                    <input class="form-control " type="number" placeholder="0.00"  step="0.01" name="price_vent" value="{{ old('price_vent') }}" required/>
                                                </div>
                                                <div class="col-md-2">
                                                    <label class="form-label">Precio Pago</label>
                                                    <input class="form-control"  type="number" placeholder="0.00" step="0.01" name="price_pag" value="{{ old('price_pag') }}" required/>
                                                </div>
                                                <div class="col-md-2">
                                                    
                                                    <label class="form-label">Fecha Inicio</label>
                                                    <input class="form-control flatpickr-basic" type="text" placeholder="YYYY-MM-DD" name="fini" value="{{ old('fini') }}" required/>
                                                </div>
                                                <div class="col-md-2">
                                                    <label class="form-label">Fecha Fin</label>
                                                    <input class="form-control flatpickr-basic" type="text" placeholder="YYYY-MM-DD" name="ffin" value="{{ old('ffin') }}" required/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control text-uppercase" type="text" placeholder="Ingresar" name="detail" cols="30" rows="3" name="detail">{{ old('detail') }}</textarea>
