                    ...
                    <div class="page-header">
                        <div class="media align-items-center">
                            ...
                            <div class="media-body pl-3">
                                <h1 class="page-header-title mb-1">Reportes De Ventas por Fechas</h1>
                                <div>
                                    <span>Usuario:</span>
                                    <a href="#" class="text--primary-2">{{ Auth::guard('admin')->user()->name }}</a>
                                    <strong> Reporte - {{\Carbon\Carbon::now()->format('Y/m/d') }}</strong>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="content-body">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin_treportes_resultados') }}" method="POST">
                            @csrf
                            <div class="row">
                                {{-- <div class="col-md-4">
