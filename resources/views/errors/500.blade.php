          ...
          <div class="misc-wrapper"><a class="brand-logo" href="{{ route('admin_home') }}">
            ...
            <div class="misc-inner p-2 p-sm-3">
              <div class="w-100 text-center">
                <img class="img-fluid p-4" src="{{ asset('images/illustration/500-internal-server-error.svg')}}" alt="" />
                <p class="lead">El servidor encontró un error interno o una configuración incorrecta y no pudo completar su solicitud.</p>
